...
//filter me va a retornar un arrewglo nuevo
let numerosGrandes = numeros.filter(function(num){
    //console.log(num);
    //retornar una expresión que me de un V o F
    return num > 2.5;
...
//2. al ser objeto todo, esto trae cosas útiles y muchas veces no tenemos que implementar la lógica de 0 para obtener un resultado que necesitemos, no tenemos que reinventar 